...
public class TC12_PargoPickupPoint_E2ETest extends BaseClass {
	   ...
	   public void pargoTest() throws InterruptedException {
          ...
          if (driver.findElements(By.xpath("//*[@id=\"__next\"]/div/div[1]/div[2]/div/div/div/div[3]/div/div[2]/div/div")).size()>0) {
        	  ...
        	  String expectedError = "An error occured retrieving available shipping methods. Please try again";
        	  
        	  WebElement error1 = driver.findElement(By.xpath("//div[contains(text(),'An error occured retrieving available shipping met')]"));
        	  
        	  Assert.assertEquals(error1, expectedError);
